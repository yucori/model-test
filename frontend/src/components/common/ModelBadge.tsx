...
const LLM_STYLES: Record<LLMProvider, string> = {
  ...
  openrouter: 'bg-orange-50 text-orange-700 ring-orange-200',
}
...
const EMB_STYLES: Record<string, string> = {
  ...
  hf:    'bg-teal-50 text-teal-700 ring-teal-200',
  openai: 'bg-sky-50 text-sky-700 ring-sky-200',
}

const EMB_LABELS: Record<string, string> = {
  local: 'HF',
  hf:    'HF',
  openai: 'OpenAI',
}
